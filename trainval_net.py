...
def parse_args():
  ...
  parser.add_argument('--t_dataset', dest='t_dataset',
                      help='target training dataset',
                      default='pascal_voc_06', type=str)
...
if __name__ == '__main__':
  ...
  # set target dataset config
  if args.t_dataset == "pascal_voc_06":
      args.t_imdb_name = "voc_2006_trainval"
      args.t_imdbval_name = "voc_2006_test"
      args.t_set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
  # set target dataset config done 
  ...
  #target roi batch
  t_sampler_batch = sampler(len(t_roidb), args.batch_size)
  #target roi batch done
  ...
  # initialize target data loader done
...
#-------------------process target data here: not gt info---------------------#
  # initilize the tensor holder here.
